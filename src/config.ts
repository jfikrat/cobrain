...
const envSchema = z.object({
  ...
  AGENT_MODEL_FAST: z.string().default("claude-sonnet-4-5"),
  AGENT_MODEL_DEFAULT: z.string().default("claude-sonnet-4-5"),
  ...
  SENTINEL_MODEL: z.string().default("claude-sonnet-4-5"),
