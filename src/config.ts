...
const envSchema = z.object({
  ...
  // v0.6: Agent model
  AGENT_MODEL: z.string().default("claude-sonnet-4"),
  ...
  AGENT_MODEL_FAST: z.string().default("claude-sonnet-4"),
  AGENT_MODEL_DEFAULT: z.string().default("claude-sonnet-4"),
  ...
  SENTINEL_MODEL: z.string().default("claude-sonnet-4"),
